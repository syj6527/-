...
const MODE_LABELS = { docu:'🎬 다큐', sports:'🏟️ 중계', variety:'📺 예능', court:'⚖️ 법정수사', guide:'🎮 공략집', wiki:'📚 위키', news:'📰 속보', bible:'🛕 성전', community:'🗣️ 커뮤니티', scp:'🗂️ 기밀문서', radio:'📻 라디오' };
// director 블록 라벨 (모드별)
...
const MODE_SUBSTYLES = {
    ...
    radio: [
        '【사연 코너 st】 라디오 DJ가 청취자 사연을 읽어주는 코너. RP 장면을 익명 사연("○○동 익명님", "라디오네임 ○○님이 보내주셨네요")으로 각색해 낭독하고, 다정하거나 능청맞은 사담을 붙인다. "오늘의 사연은요~", "어머 이분 좀 보세요", "사연자분, 제 말 듣고 계시죠?". 새벽 감성(나긋·위로)부터 정오 수다(밝고 텐션)까지 분위기를 살린다.',
        '【라디오 스포츠 중계 st】 화면 없이 "귀로만" 듣는 라디오 중계. 안 보이는 장면을 말로 폭풍 묘사하다, 결정적 순간엔 "아 여러분 이걸 보셔야 하는데!", "제 입으로는 도저히 다 못 전해드려요!"로 안타까워한다. 흥분과 묘사 사이를 오가는 특유의 다급함. "지금 들어오고 있습니다!", "아아 이런 장면이!".',
        '【뉴스·교통 코너 st】 라디오 시보·정시 뉴스 아나운서 톤. "○시를 알려드립니다", "방금 들어온 소식입니다", "다음은 교통정보입니다". 사소한 일상을 정시 뉴스·교통 체증처럼 건조하고 정확하게 보도하다 시시하게 착지. 차분한 아나운서체.',
        '【심야 고민상담 st】 새벽 라디오 고민상담 코너. 청취자(=캐릭터)의 사연을 진지하게 받아 위로·조언하다가, 결국 "그냥… 고백하세요" 같은 허무할 만큼 단순한 결론으로 데드팬 착지. 나긋하고 다정한 심야 DJ 톤, 긴 호흡.',
    ],
};
...
const SUBLABELS = {
    ...
    radio: [
        ['오늘의 사연', '사연 배달', '라디오네임'],   // 사연 코너
        ['중계석', '귀로 듣는 중계', '현장음'],        // 라디오 스포츠중계
        ['정시 뉴스', '교통정보', '시보'],            // 뉴스·교통
        ['고민상담', '속풀이', '심야 상담'],          // 고민상담
    ],
};
...
[코너별 director(온에어) 도입 예시 — 지정된 코너 것만 따를 것]
- 사연: "자~ 오늘의 사연, ○○동 익명님께서 보내주셨습니다. '…' 어머 익명님, 그건…(웃음)"
- 라디오 스포츠 중계: "자 지금 ○○ 선수 움직입니다— 아 여러분 이걸 보셔야 하는데! 제 입으론 도저히—! 아아, 들어갔습니다!"
- 뉴스·교통: "○시 뉴스를 알려드립니다. 방금 들어온 소식입니다. 이어서 교통정보, 현재 ○○ 일대는 정체가 극심합니다."
- 고민상담: "음… 사연 잘 들었어요. 많이 힘드셨겠다. 근데요, 제 생각엔… 그냥, 고백하세요."
