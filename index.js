...
[예시 — 톤의 '구조'만 참고, 코너 어조는 서브스타일을 따를 것]
- inner: "[사연 너머] 그는 사실 답을 정해두고도, 누가 등 떠밀어주길 기다리는 중이다."
- director(온에어): "자~ 오늘의 사연, ○○동 익명님께서 보내주셨습니다. '제 친구가 자꾸 제 옆자리만 맡아둬요…' 어머, 익명님. 그건 친구가 아니라요…(웃음)"
- fact(신청곡): "잔나비 〈주저하는 연인들을 위해〉 — 제목부터 사연자분 들으라고 만든 곡 같네요. (가사 없이 선곡 이유만)"
- interview(청취자 문자): "달빛님: DJ 또 오지랖 ㅋㅋ / 익명님: 사연자 빨리 고백해라 / ☆☆: 신청곡 선곡 미쳤다"`,
    };
